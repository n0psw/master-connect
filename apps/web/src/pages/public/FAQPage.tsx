...
export const FAQPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Консультации проходят в формате видео-звонков через нашу платформу. Это одноразовые консультации, где вы получаете конкретные ответы на ваши вопросы и четкий план действий. Длительность может быть 30, 45 или 60 минут в зависимости от ваших потребностей."
    },
    {
